        ...
        <Card>
            <div className="card-body">
                    <div className="text-center">
                        ...
                        <h4 className="modal-title text-primary pt-1" ><u>Asset Requisition List</u></h4>
                    </div>
                </div>
                <hr></hr>
    ...
    return (
        <Modal open={isModalOpen} onOk={handleOk} onCancel={handleCancel} style={{
            ...
            <div className="text-center">
                ...
                <h4 className="modal-title text-primary pt-1" ><u>New Asset Requisition Document</u></h4>
            </div>
            <hr></hr>
