        ...
        <Card>
            <div className="card-body">
                <div className="text-center">
                    ...
                    < h4 className='pt-1 text-primary'>Fuel Recharge Card List</h4>
                </div>
                <hr></hr>
                    ...
                    <table className="table table-hover table-bordered dt-responsive nowrap">
                        <thead>
                            <tr>
                                ...
                                <th className='small text-primary text-center bg-secondary' scope="col">Card No</th>
                                <th className='small text-primary text-center bg-secondary' scope="col">Vehicle</th>
                                <th className='small text-primary text-center bg-secondary' scope="col">Max.Amount Allocated (Ksh)</th>
                                <th className='small text-primary text-center bg-secondary' scope="col">Amount Consumed</th>
                                <th className='small text-primary text-center bg-secondary' scope="col">Amount to Topup (Ksh.)</th>
            ...
            <FuelRechargeModal isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen} />
        </Card>
    );
};

function FuelRechargeModal({ setIsModalOpen, isModalOpen }) {
        ...
        <Modal open={isModalOpen} onOk={handleOk} onCancel={handleCancel} style={{
            ...
            <div className="row g-4">
                <div className="col-12 col-md-3">
                    <p className='h6 text-primary  ls-wider '>Donor  :</p>
                    <select
                ...
                <div className="col-12 col-md-3">
                    <p className='h6 text-primary ls-wider '>Amount to Topup :</p>
            ...
            <div className="col-12 px-3 pb-4 " style={{ backgroundColor: '#d5d3d3', cursor: 'pointer' }}>
                ...
                <p className='h5 fw-bold text-primary ls-wider '>Remarks</p>
