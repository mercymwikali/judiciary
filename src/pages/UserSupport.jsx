        ...
        <Card>
            <div className="card-body">
                <div className="text-center">
                    ...
                    < h4 className='pt-1 text-primary'>ICT Requsition List</h4>
                </div>
                <hr></hr>
                    ...
                    <table className="table table-hover table-bordered dt-responsive nowrap">
                        <thead>
                            <tr>
                                ...
                                <th className='small text-primary text-center bg-secondary' scope="col">Assignee</th>
            ...
            <UserSupportModal isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen} />
        </Card>
    );
};

function UserSupportModal({ setIsModalOpen, isModalOpen }) {
    ...
    return (
        <Modal open={isModalOpen} onOk={handleOk} onCancel={handleCancel} style={{
            ...
            <div className="text-center">
                ...
                <h4 className="modal-title text-primary pt-2" ><u>New ICT Request</u></h4>
            </div>
            <hr></hr>
            <div className="row g-4">
                <div className="col-12 col-md-3">
                    <p className='fw-normal text-primary  ls-wider text-decoration-underline'>Status  :</p>
                    <select
                ...
                <div className="col-12 col-md-3">
                    <p className='fw-normal text-primary ls-wider text-decoration-underline'>Requsition Category :</p>
                    <select
                        className="form-select"
                        aria-label="Default select example"
                        value={Year}
                ...
                <div className="col-12 col-md-3">
                    <p className='fw-normal text-primary ls-wider text-decoration-underline'>Urgency :</p>
                    <select
                        className="form-select"
                        aria-label="Default select example"
                        value={Year}
