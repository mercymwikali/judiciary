        ...
        <Card>
            <div className="card-body">
                <div className="text-center">
                    ...
                    < h4 className='pt-1 text-primary'>Fuel Requisition List</h4>
                </div>
                <hr></hr>
                    ...
                    <table className="table table-hover table-bordered dt-responsive nowrap">
                        <thead>
                            <tr>
                                ...
                                <th className='small text-primary text-center bg-secondary' scope="col">Requisition Type</th>
                                <th className='small text-primary text-center bg-secondary' scope="col">Fuel Type</th>
                                <th className='small text-primary text-center bg-secondary' scope="col">Vehicle</th>
                                <th className='small text-primary text-center bg-secondary' scope="col">Price Per Litre (Ksh)</th>
                                <th className='small text-primary text-center bg-secondary' scope="col">Quantity</th>
                                <th className='small text-primary text-center bg-secondary' scope="col">Total Price (Ksh.)</th>
            ...
            <FuelReqModal isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen} />
        </Card>
    );
};

function FuelReqModal({ setIsModalOpen, isModalOpen }) {
    ...
    return (
        <Modal open={isModalOpen} onOk={handleOk} onCancel={handleCancel} style={{
            ...
            <div className="text-center">
                ...
                <h4 className="modal-title text-primary pt-2" ><u>New Fuel Request</u></h4>
            </div>
            <hr></hr>
            <div className="row g-4">
                <div className="col-12 col-md-3">
                    <p className='fw-normal text-primary  ls-wider '>Donor  :</p>
                    <select
                ...
                <div className="col-12 col-md-3">
                    <p className='fw-normal text-primary ls-wider '>Date Required :</p>
                    <select
                        className="form-select"
                        aria-label="Default select example"
                        value={Year}
                ...
                <div className="col-12 col-md-3">
                    <p className='fw-normal text-primary ls-wider '>Project :</p>
                    <select
                        className="form-select"
                        aria-label="Default select example"
                        value={Year}
                ...
                <div className="col-12 col-md-3">
                    <p className='fw-normal text-primary ls-wider '>Requisition Type :</p>
                    <select
                        className="form-select"
                        aria-label="Default select example"
                        value={Year}
            ...
            <div className="row g-4 mt-3">
                <div className="col-12 col-md-3">
                    <p className='fw-normal text-primary  ls-wider '>Fuel Type  :</p>
                    <select
                        className="form-select"
                        aria-label="Default select example"
                        value={Year}
                ...
                <div className="col-12 col-md-3">
                    <p className='fw-normal text-primary ls-wider '>Driver :</p>
                    <select
                        className="form-select"
                        aria-label="Default select example"
                        value={Year}
                ...
                <div className="col-12 col-md-3">
                    <p className='fw-normal text-primary ls-wider '>Vehicle :</p>
                    <select
                        className="form-select"
                        aria-label="Default select example"
                        value={Year}
                ...
                <div className="col-12 col-md-3">
                    <p className='fw-normal text-primary ls-wider '>Vendor(Dealer):</p>
                    <select
                        className="form-select"
                        aria-label="Default select example"
                        value={Year}
            ...
            <div className="row g-4 mt-3">
                <div className="col-12 col-md-3">
                    <p className='fw-normal text-primary  ls-wider '>Responsibility Center:</p>
                    <select
                        className="form-select"
                        aria-label="Default select example"
                        value={Year}
                ...
                <div className="col-12 col-md-3">
                    <p className='fw-normal  text-primary ls-wider '>Activity/Beneficiary Name :</p>
                    <select
                        className="form-select"
                        aria-label="Default select example"
                        value={Year}
                ...
                <div className="col-12 col-md-3">
                    <p className='fw-normal text-primary ls-wider '>Odometer Reading :</p>
                    <Input></Input>
                </div>
                <div className="col-12 col-md-3">
                    <p className='fw-normal text-primary ls-wider '>Quantity of Fuel (Litres) :</p>
                    <Input></Input>
                </div>
            </div>
            ...
            <div className="col-12 px-3 pb-4 " style={{ backgroundColor: '#d5d3d3', cursor: 'pointer' }}>
                ...
                <p className='h5 fw-normal text-primary ls-wider '>Remarks</p>
