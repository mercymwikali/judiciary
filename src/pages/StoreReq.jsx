            ...
            <div className="card-body">
                <div className="text-center">
                    <div className="text-center">
                        ...
                        <h4 className="modal-title text-primary pt-1" ><u>Store Requisition List</u></h4>
                    </div>
                </div>
                <hr></hr>
    ...
    return (
        <Modal open={isModalOpen} onOk={handleOk} onCancel={handleCancel} style={{
            ...
            <div className="text-center">
                ...
                <h4 className="modal-title text-primary pt-1" ><u>New Store Requisition Document</u></h4>
            </div>
            <hr></hr>
            <div className="row g-3">
                <div className="col-12 col-md-4 ">
                    <p className='h6 text-primary ls-wider'>Donor Name:</p>
                    <select
                ...
                <div className="col-12 col-md-4 ">
                    <p className='h6  text-primary ls-wider '>Project :</p>
                    <select
                        className="form-select"
                        aria-label="Default select example"
                        value={Year}
                ...
                <div className="col-12 col-md-4 ">
                    <p className='h6  text-primary ls-wider'>Date Requires:</p>
                    <select
                        className="form-select"
                        aria-label="Default select example"
                        value={Year}
