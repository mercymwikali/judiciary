...
function AppraisalReq(params) {
    ...
    return (
        <div className="card">
            ...
            < h4 className='px-3 pt-3 text-primary'>Appraisal Requisition List</h4>
                <Divider/>
                <Link type='button' to='/new doc' className='text-decoration-none my-3 btn btn-primary'><PlusOutlined style={{color:'#fff', hover:'#000'}}/> Create New Document</Link>
